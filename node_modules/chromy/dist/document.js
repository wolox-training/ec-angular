...
var Document = function () {
  ...
  (0, _createClass3.default)(Document, [{
    ...
    value: function waitUntilVisible(selector) {
      var _this5 = this;

      var _check2, startTime;

      return _regenerator2.default.async(function waitUntilVisible$(_context24) {
        while (1) {
          switch (_context24.prev = _context24.next) {
            case 0:
              ...
              _context24.next = 4;
              return _regenerator2.default.awrap(new Promise(function (resolve, reject) {
                _check2 = function check() {
                  setTimeout(function _callee5() {
                    var now, result;
                    return _regenerator2.default.async(function _callee5$(_context23) {
                      while (1) {
                        switch (_context23.prev = _context23.next) {
                          case 0:
                            ...
                            if (!(now - startTime > _this5.chromy.options.waitTimeout)) {
                              _context23.next = 5;
                              break;
                            }
                          ...
                          case 5:
                            _context23.next = 7;
                            return _regenerator2.default.awrap(_this5.visible(selector));
                  ...
                  }, _this5.chromy.options.waitFunctionPollingInterval);
                };
                _check2();
              }));
    ...
    value: function type(expr, value) {
      var characters, i, c;
      return _regenerator2.default.async(function type$(_context25) {
        while (1) {
          switch (_context25.prev = _context25.next) {
            ...
            case 2:
              ...
              _context25.t0 = _regenerator2.default.keys(characters);
    ...
    value: function sleep(msec) {
      return _regenerator2.default.async(function sleep$(_context26) {
        while (1) {
    ...
    value: function getBoundingClientRect(selector) {
      return _regenerator2.default.async(function getBoundingClientRect$(_context27) {
        while (1) {
          switch (_context27.prev = _context27.next) {
            case 0:
              return _context27.abrupt('return', this.rect(selector));
    ...
    value: function rect(selector) {
      var rect;
      return _regenerator2.default.async(function rect$(_context28) {
        while (1) {
    ...
    value: function rectAll(selector) {
      var rects;
      return _regenerator2.default.async(function rectAll$(_context29) {
        while (1) {
          switch (_context29.prev = _context29.next) {
            ...
            case 2:
              rects = _context29.sent;
              return _context29.abrupt('return', rects.map(function (rect) {
                return {
                  top: Math.floor(rect.top),
                  left: Math.floor(rect.left),
                  width: Math.floor(rect.width),
    ...
    value: function _getObjectIdFromNodeId(nodeId) {
      ...
      return _regenerator2.default.async(function _getObjectIdFromNodeId$(_context30) {
        while (1) {
          switch (_context30.prev = _context30.next) {
            ...
            case 6:
              return _context30.abrupt('return', rObj.objectId);
    ...
    value: function _getNodeId() {
      ...
      return _regenerator2.default.async(function _getNodeId$(_context31) {
        while (1) {
          switch (_context31.prev = _context31.next) {
            ...
            case 3:
              _ref3 = _context31.sent;
              root = _ref3.root;

              this.nodeId = root.nodeId;

            case 6:
              return _context31.abrupt('return', this.nodeId);
    ...
    value: function _getScreenInfo() {
      return _regenerator2.default.async(function _getScreenInfo$(_context32) {
        while (1) {
